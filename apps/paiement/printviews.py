...
def declaration_receipt_view(request, declaration_id):
    ...
    client = Profile.objects.get(account=declaration.created_by)
    ...
    for employee in employees:
        data.append([counter, employee.passport_number, f"{employee.first} {employee.last}", employee.job, employee.job_category, employee.phone])
        counter +=1

    LIST_STYLE = TableStyle(
        [
            ('LINEABOVE', (0,0), (5,1), 2, colors.black),
            ('LINEABOVE', (0,0), (-1,-1), 1, colors.black),
            ('LINEBEFORE', (0,0), (counter,5), 1, colors.black),
            ('BOX', (0,0), (5,-1), 2, colors.black),
            ('FONTSIZE', (0,1), (5,counter), 9, colors.black),
            ('FONTSIZE', (0,0), (0,5), 11, colors.black),
            ('BACKGROUND', (0,0), (5,0), colors.lightgrey),
        ]
    )
    table = Table(data, colWidths=83, splitByRow=1, style=LIST_STYLE)

    pdf.setFontSize(12)
    pdf.drawString(60, 580, f"Liste des employé(e)s")

    pdf.setFontSize(8)
    table.wrapOn(pdf, 55, 450)
    table.drawOn(pdf, 55, 450)
...
def bill_receipt_view(request, bill_id):
    ...
    LIST_STYLE = TableStyle(
        [
            ('LINEABOVE', (0,0), (3,1), 2, colors.black),
            ('LINEABOVE', (0,0), (-1,-1), 1, colors.black),
            ('LINEBEFORE', (0,0), (4,3), 1, colors.black),
            ('BOX', (0,0), (3,-1), 2, colors.black),
    ...
    table = Table(data, colWidths=123, style=LIST_STYLE)
...
def payment_receipt_view(request, payment_id):
    ...
    LIST_STYLE = TableStyle(
        [
            ('LINEABOVE', (0,0), (3,1), 2, colors.black),
            ('LINEABOVE', (0,0), (-1,-1), 1, colors.black),
            ('LINEBEFORE', (0,0), (4,2), 1, colors.black),
            ('BOX', (0,0), (4,-1), 2, colors.black),
    ...
    pdf.drawImage('staticfiles/payment_qr.png', 60, 480, 90, 90, showBoundary=False)
